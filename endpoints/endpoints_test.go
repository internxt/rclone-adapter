...
func TestEndpointConstruction(t *testing.T) {
	...
	tests := []struct {
		...
		{"Folder ContentFolders", cfg.Drive().Folders().ContentFolders("parent-uuid"), "https://gateway.internxt.com/drive/folders/v2/content/parent-uuid/folders"},
		{"Folder ContentFiles", cfg.Drive().Folders().ContentFiles("parent-uuid"), "https://gateway.internxt.com/drive/folders/v2/content/parent-uuid/files"},
		...
		{"Folder Check Folders Existence", cfg.Drive().Folders().CheckFoldersExistence("parent-uuid"), "https://gateway.internxt.com/drive/folders/content/parent-uuid/folders/existence"},
